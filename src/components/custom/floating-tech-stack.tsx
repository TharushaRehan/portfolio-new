...
const Icon = ({
  ...
  // Fixed random duration for this icon
  const [floatingDuration] = React.useState(() => 5 + Math.random() * 5);
...
const FloatingTechStack = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> & FloatingTechStackProps
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        <h1 className="text-3xl md:text-5xl font-bold tracking-tight bg-linear-to-b from-foreground to-foreground/70 text-transparent bg-clip-text">
          {title}
        </h1>
