...
const Approach = () => {
  return (
    <section className="w-full py-20">
      ...
      <div
        className="my-20 flex flex-col lg:flex-row items-center 
      ...
      >
        ...
        <Card
          ...
          and dive into coding. From initial sketches to polished code, 
        ...
        <Card
          ...
          description="This is where the magic happens! Based on the 
          approved design, I'll translate everything into functional code,
...
const Card = ({
  ...
  return (
    <div
      ...
      max-w-sm w-full mx-auto p-4 lg:h-[35rem] relative rounded-3xl"
    >
      ...
      <div className="relative z-20">
        ...
        mx-auto flex items-center justify-center absolute top-[50%]
        ...
        <h2
          className="dark:text-white text-center text-sm opacity-0 
          group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4 
          font-bold group-hover/canvas-card:text-white 
          group-hover/canvas-card:-translate-y-2 transition duration-200"
          style={{ color: "#e4ecff" }}
...
const AceternityIcon = ({ order }: { order?: string }) => {
  return (
    <div>
      ...
      justify-center rounded-full border border-slate-800 
      bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] 
      bg-[length:200%_100%] px-6 text-slate-400 
